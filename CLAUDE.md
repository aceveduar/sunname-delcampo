...
| 2026-08-20    | Caja: el foco regresa solo al buscador después de agregar un producto (normal o a granel) -- un cajero escaneando seguido ya no tiene que hacer clic de vuelta en el buscador entre cada producto | Encontrado revisando capturas reales de uso pedidas por el usuario ("¿mejoraríamos algo de Caja?"); mejora concreta de velocidad para el flujo que más se usa del sistema |
